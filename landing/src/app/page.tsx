      ...
      <div className="relative z-[2]">
        ...
        <section className="hero-glow pt-20 pb-10 sm:pt-28 sm:pb-14 lg:pt-32 lg:pb-16">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
            ...
            <FadeUp delay={0.1}>
              <h1 className="mt-6 text-4xl lg:text-6xl font-bold tracking-tight text-on-background font-headline">
                Orchestrate AI agent teams from your terminal.
              </h1>
            </FadeUp>

            <FadeUp delay={0.15}>
              <p className="mt-5 text-lg text-on-surface-variant max-w-2xl mx-auto leading-relaxed font-body">
            ...
            <FadeUp delay={0.2}>
              <div className="mt-10 mx-auto max-w-2xl">
                ...
                <div className="flex items-center justify-center gap-1 mb-3">
                  {tabs.map((t) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded text-xs font-label font-medium transition-colors ${
                        platform === t
                ...
                <p className="mt-3 text-sm text-on-surface-variant font-body">
                  Then run:{" "}
                  <code className="text-on-surface-variant font-label">
                    bc init && bc up
                  </code>
                </p>
              </div>
              ...
              <div className="mt-8 flex flex-col items-center gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <Link
                    ...
                    className="inline-flex h-11 items-center gap-2 rounded-lg border border-outline-variant/20 px-6 text-sm font-medium text-on-surface-variant transition-colors hover:bg-surface-container active:scale-[0.97] font-body"
                  >
        ...
        {/* ════════════════════════════════════════
           ...
           ════════════════════════════════════════ */}
        <RevealSection className="py-8 sm:py-12">
        ...
        <RevealSection className="py-10 sm:py-14">
          <div className="mx-auto max-w-4xl px-4 sm:px-6">
            <FadeUp>
              <h2
                className="text-2xl font-bold tracking-tight text-on-background text-center mb-10 font-headline"
              >
        ...
        <RevealSection className="py-10 sm:py-14">
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            <FadeUp className="text-center mb-10">
              <h2
                className="text-2xl font-bold tracking-tight text-on-background font-headline"
              >
                Real-time visibility.
              </h2>
              <p className="mt-3 text-on-surface-variant text-base max-w-xl mx-auto font-body">
        ...
        <RevealSection className="py-12 sm:py-16">
          <div className="mx-auto max-w-2xl px-4 sm:px-6 text-center">
            ...
            <p className="mt-3 text-on-surface-variant text-base font-body">
