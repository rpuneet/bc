...
See [docs/explanation/notifications.md](../../docs/explanation/notifications.md) for the full notification architecture, including the 3-part adapter pattern, filtering logic, and database schema.
