...
> **Superseded**: This proposal (v3, 2026-04-09) has been superseded by [docs/architecture/channels.md](../architecture/channels.md).
> Key change: channels are now **inbound notification-only** -- agents handle outbound via injected credentials.
> Kept as historical reference for the UI wireframes, setup wizard steps, and file handling design.
